...
void optimize_cats_new_working(const int NCAT){
	// gROOT->ProcessLine(".x /afs/cern.ch/work/n/nchernya/setTDRStyle.C");

	TString s;
	// TString date = "OldPairing_M60";
	TString date = "20201501";
	TString path_sig = s.Format("/eos/home-t/twamorka/16April2020_Ntuples_BDTPairing/m_60/22April2020_withreweighting_phoMVA_diffParamTrain/");
	TString path_bkg_data = s.Format("/eos/home-t/twamorka/16April2020_Ntuples_BDTPairing/m_60/22April2020_withreweighting_phoMVA_diffParamTrain/");
	TString path_data = s.Format("/eos/home-t/twamorka/16April2020_Ntuples_BDTPairing/m_60/22April2020_withreweighting_phoMVA_diffParamTrain/");
