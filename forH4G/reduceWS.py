...
for m in mass:
    ...
    inFile = '/eos/user/t/twamorka/HtoAAto4Gamma_2019/2016Analysis/forCombine/17Sep2019/Signal/'+str(m)+'/add/signal_m_'+str(m)+'.root'
    ...
    inFileWS = '/eos/user/t/twamorka/HtoAAto4Gamma_2019/2016Analysis/forCombine/17Sep2019/Signal/'+str(m)+'/output_SUSYGluGluToHToAA_AToGG_M-'+str(m)+'_TuneCUETP8M1_13TeV_pythia8.root '
    ...
    outFileWS = '/eos/user/t/twamorka/HtoAAto4Gamma_2019/2016Analysis/forCombine/17Sep2019/Signal/reducedWS/w_signal_'+str(m)+'.root'
